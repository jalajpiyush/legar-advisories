    ...
    <div className="flex flex-col h-full bg-white dark:bg-neutral-900 pt-16 md:pt-0">
      ...
      <div className="px-8 py-6 border-b border-gray-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 sticky top-0 z-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <motion.h1 layoutId="page-title" className="text-2xl font-serif text-gray-900 dark:text-neutral-100 mb-1">Guidance & Playbooks</motion.h1>
            <motion.p layoutId="page-description" className="text-[14px] text-gray-500 dark:text-neutral-400">Firm-approved guides, standard positions, and legal playbooks.</motion.p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredTopics.length > 0 ? (
              filteredTopics.map(topic => {
                ...
                return (
                  <div key={topic.id} className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800/80 rounded-xl p-5 hover:shadow-md hover:border-gray-300 dark:border-neutral-700 transition-all cursor-pointer group flex flex-col h-full">
                    <div className="flex items-start justify-between mb-3">
                      <div className="w-10 h-10 rounded-lg bg-gray-50 dark:bg-neutral-900 flex items-center justify-center text-gray-700 dark:text-neutral-300">
                    ...
                    <h3 className="font-semibold text-gray-900 dark:text-neutral-100 text-[16px] mb-2 leading-snug group-hover:text-blue-600 transition-colors">
                      {topic.title}
                    </h3>
                    
                    <p className="text-[14px] text-gray-500 dark:text-neutral-400 mb-6 flex-1 line-clamp-3">
                      {topic.description}
                    </p>
                    
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-neutral-800 mt-auto">
                      <span className="text-[12px] font-medium text-gray-400 dark:text-neutral-500">
                        {topic.readTime}
                      </span>
              ...
              <div className="col-span-full py-12 text-center text-gray-500 dark:text-neutral-400">
                ...
                <p className="text-[15px] font-medium text-gray-900 dark:text-neutral-100 mb-1">No guidance found</p>
