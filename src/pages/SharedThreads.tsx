    ...
    <div className="flex flex-col h-full bg-white dark:bg-neutral-900 pt-16 md:pt-0">
      ...
      <div className="px-8 py-6 border-b border-gray-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 sticky top-0 z-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <motion.h1 layoutId="page-title" className="text-2xl font-serif text-gray-900 dark:text-neutral-100 mb-1">Shared Threads</motion.h1>
            <motion.p layoutId="page-description" className="text-[14px] text-gray-500 dark:text-neutral-400">Collaborate and view AI conversations shared with your team.</motion.p>
          </div>
        </div>
            ...
            <div className="divide-y divide-gray-100">
              {filteredThreads.length > 0 ? (
                filteredThreads.map(thread => (
                  <div key={thread.id} className="flex items-start gap-4 p-5 hover:bg-gray-50 dark:bg-neutral-900 transition-colors cursor-pointer group">
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0 bg-blue-50 text-blue-600">
                      <Share2 className="w-5 h-5" />
                    </div>
                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                      <h3 className="text-[15px] font-medium text-gray-900 dark:text-neutral-100 mb-1.5 truncate group-hover:text-blue-600 transition-colors">
                        {thread.title}
                      </h3>
                    ...
                    <div className="flex items-center gap-2 self-center">
                      ...
                      <button className="p-2 text-gray-400 dark:text-neutral-500 hover:text-gray-900 dark:text-neutral-100 hover:bg-gray-100 dark:bg-neutral-800 rounded-lg opacity-0 group-hover:opacity-100 transition-all">
                ...
                <div className="p-12 text-center flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-neutral-800 flex items-center justify-center mb-3">
                    <Share2 className="w-6 h-6 text-gray-400 dark:text-neutral-500" />
                  </div>
                  <h3 className="text-[15px] font-medium text-gray-900 dark:text-neutral-100 mb-1">No shared threads found</h3>
