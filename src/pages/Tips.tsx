    ...
    <div className="flex flex-col h-full bg-white dark:bg-neutral-900 pt-16 md:pt-0">
      ...
      <div className="px-8 py-6 border-b border-gray-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 sticky top-0 z-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            <motion.h1 layoutId="page-title" className="text-2xl font-serif text-gray-900 dark:text-neutral-100 mb-1">Tips & Tricks</motion.h1>
            <motion.p layoutId="page-description" className="text-[14px] text-gray-500 dark:text-neutral-400">Enhance your productivity with expert advice and best practices.</motion.p>
          </div>
        </div>
        ...
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-5">
          {filteredTips.length > 0 ? (
            filteredTips.map(tip => {
              const Icon = tip.icon;
              return (
                <div key={tip.id} className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800/80 rounded-xl p-5 hover:shadow-md hover:border-gray-300 dark:border-neutral-700 transition-all cursor-pointer group flex flex-col h-full">
            ...
            <div className="col-span-full py-12 text-center text-gray-500 dark:text-neutral-400">
              <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-neutral-800 flex items-center justify-center mx-auto mb-3">
                <Lightbulb className="w-6 h-6 text-gray-400 dark:text-neutral-500" />
              </div>
              <p className="text-[15px] font-medium text-gray-900 dark:text-neutral-100 mb-1">No tips found</p>
