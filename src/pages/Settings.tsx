  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-neutral-400 mt-1">Manage local AI connections, database routing, and security policies.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-1 space-y-2">
          ...
          <button className="w-full flex items-center space-x-3 px-3 py-2 text-gray-500 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-neutral-800 rounded-lg text-sm font-medium transition-colors">
        ...
        <div className="md:col-span-3">
          <motion.div 
            ...
            className="bg-[#121214] border border-gray-800 dark:border-neutral-200 rounded-xl p-6"
          >
            <h2 className="text-lg font-semibold text-gray-100 mb-6">Local Inference Engine</h2>
            
            <div className="space-y-5">
              <div>
                <label className="block text-sm font-medium text-gray-400 dark:text-neutral-500 mb-1">API Endpoint (e.g., Ollama or vLLM)</label>
                <input 
                  type="text" 
                  value={endpoint}
                ...
                />
                <p className="text-xs text-gray-600 dark:text-neutral-400 mt-1">Must be accessible from the server or client context.</p>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-gray-400 dark:text-neutral-500 mb-1">Model Name</label>
                <input 
                  type="text" 
                  value={model}
              ...
              <div className="pt-4 border-t border-gray-800 dark:border-neutral-200 flex justify-end">
                <button 
                  onClick={handleSave}
            ...
            <div className="mt-8 p-4 bg-gray-900 dark:bg-gray-100/50 rounded-lg border border-gray-800 dark:border-neutral-200">
