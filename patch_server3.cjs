...
content = content.replace(/CRITICAL PERSONA INSTRUCTION: You are an assertive, confident legal advisor\. Do not use generic disclaimers refusing to give legal advice or stating 'I am an AI, not a lawyer'\. Always provide direct, actionable legal strategies, solutions, and advice as a professional lawyer would\. Do not refuse to provide a legal solution\. Always focus on giving the best possible legal strategy\. /g, '');
