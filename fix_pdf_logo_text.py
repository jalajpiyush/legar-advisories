...
if old_export_fn_match:
  ...
  element.innerHTML = `
    <style>
      ...
      .markdown-content h1 { font-size: 14pt; text-align: center; text-transform: uppercase; border-bottom: 1px solid #000; padding-bottom: 8px; margin-top: 30pt; display: none; } /* Hide h1 if we already have title */
        ...
        <table class="pdf-header-table">
          <tr>
            <td style="text-align: left; vertical-align: bottom;">
              <h2 class="pdf-logo-text">Legal Advisories</h2>
              <p class="pdf-header-subtitle">Official Document</p>
            </td>
