...
old_header_match = re.search(r'<!-- Failsafe Table Layout for Header -->.*?</table>', content, re.DOTALL)
...
if old_header_match:
    ...
    new_header = """<!-- Failsafe Table Layout for Header -->
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 24pt; border: none;">
        <tr>
          <td style="text-align: left; vertical-align: middle; padding: 0; border: none; width: 15%;">
          ...
          <td style="text-align: left; vertical-align: middle; padding: 0; border: none; width: 60%;">
          ...
          <td style="text-align: right; vertical-align: middle; padding: 0; border: none; width: 25%;">
      ...
      <hr style="border: none; border-top: 1px solid #000; margin-bottom: 24pt;" />"""
